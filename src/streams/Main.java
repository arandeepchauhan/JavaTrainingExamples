...
public class Main {
    ...
    public static void streamExample3() {
        new Main().memberNames.stream().filter((s) -> s.startsWith("A"))
    ...
    public static void streamExample5() {
        new Main().memberNames.stream().sorted()
                .map(String::toUpperCase)
                .forEach(System.out::println);
System.out.println("\n\n In Reverse order\n\n");

        new Main().memberNames.stream().sorted(Collections.reverseOrder())
                .map(String::toUpperCase)
                .forEach(System.out::println);
    }
    ...
    public static void streamExample6() {
        ...
        List<String> memNamesInUppercase = new Main().memberNames.stream().sorted()
                .map(String::toUpperCase)
    ...
    public static void streamExample7() {
        ...
        boolean matchedResult = new Main().memberNames.stream()
                .anyMatch((s) -> s.startsWith("A"));

        System.out.println(matchedResult);

        matchedResult = new Main().memberNames.stream()
